...
ami_assert(_proc.exitcode == 0, "Failed to get block connected ledgers: " .. _proc.stderrStream:read("a"))
...
local _proc = proc.spawn("bin/signer", { "import", "secret", "key", "baker", "ledger://" .. _legerId .. "/" .. _derivationPath, _options.force and "--force" or nil }, {
	stdio = "inherit",
	wait = true,
	env = { HOME = _homedir}
})
...
local _proc = proc.spawn("bin/client", { "import", "secret", "key", "baker", "ledger://" .. _legerId .. "/" .. _derivationPath, _options.force and "--force" or nil }, {
	stdio = "inherit" ,
	wait = true,
	env = { HOME = _homedir }
})
